        ...
        <div class="flex items-center w-full">
            <div class="logo">
                <a href="<?php echo $site_url ?>">
                    ...
                    <img class="dark:hidden block" mode-light width="130" src="<?php echo $site_url ?>static/img/logo/<?php echo Zon_Config('site_logo_light') ?>" alt="game store">
                    <?php // This logo image will appear if the theme is in dark mode  ?>
                    <img class="dark:block hidden" mode-dark width="130" src="<?php echo $site_url ?>static/img/logo/<?php echo Zon_Config('site_logo_dark') ?>" alt="game store">
                </a>
            </div>
            <ul class="flex ml-12">
                <?php // Newest  ?>
...
<div class="mobile-header sticky mb-6 hidden bg-white shadow-lg dark:bg-zinc-900 items-center flex justify-between w-full">
    ...
    <a href="<?php echo $site_url ?>" class="no-search-component">
        <img class="dark:hidden block" mode-light width="130" src="<?php echo $site_url ?>static/img/logo/logo-dark.png" alt="game store">
        <img class="dark:block hidden" mode-dark width="130" src="<?php echo $site_url ?>static/img/logo/logo.png" alt="game store">
    </a>
