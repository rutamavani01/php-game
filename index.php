...
<body class="bg-dark dark:bg-[#121317]">
    ...
    <div class="cat-container px-4  relative mt-4">
        <button
            class="left ml-2 mt-1 w-10 h-10 hidden absolute left-0 rounded-full bg-gray-200 dark:bg-zinc-800 text-gray-700 dark:hover:bg-zinc-700 hover:bg-gray-300 dark:text-white bi-chevron-left"></button>
        <?php // Categories Loop ?>
        <div class="cat-item-container scroll-hidden w-full overflow-x-scroll flex gap-4">
            ...
            <a href="<?php echo $site_url ?>game/<?= $row['slug'] ?>"
                class="py-3 px-4 transition whitespace-nowrap dark:text-gray-300 dark:bg-[#1b1d22] duration-300 mb-2 hover:bg-blue-600 hover:text-gray-100 text-gray-600 text-sm rounded-md bg-gray-200"><?= $row['name'] ?></a>
            <?php } ?>
        </div>
        <?php // Categories Loop End ?>
        <button
            class="right h-10 mr-2 mt-0 absolute right-0 top-0 w-10 rounded-full bg-gray-200 dark:bg-zinc-800 text-gray-700 dark:hover:bg-zinc-700 hover:bg-gray-300 dark:text-white bi-chevron-right"></button>
    </div>
...
<script>
// Optional script for hover scaling animation
